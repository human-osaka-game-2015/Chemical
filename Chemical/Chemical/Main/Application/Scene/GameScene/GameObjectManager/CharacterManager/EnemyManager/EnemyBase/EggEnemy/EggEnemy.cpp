...
namespace Game
{
	...
	//----------------------------------------------------------------------
	EggEnemy::EggEnemy(D3DXVECTOR2* _pPosotion,int EnemyType) :
	...
	void EggEnemy::CollisionTaskUpdate()
	{
		if (!m_AiEnable)
		{
			return;
	...
	void EggEnemy::EnemyAi()
	{
		
	}

	void EggEnemy::DamageDecision()
	{
