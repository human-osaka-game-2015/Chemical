/**
 * @file	WarpExitGimmick.h
 * @brief	ワープギミッククラス定義
 * @author	morimoto
 */
#ifndef GAME_WARPEXITGIMMICK_H
#define GAME_WARPEXITGIMMICK_H
...
{
	/*** ワープギミッククラス */
	class WarpExitGimmick : public StageGimmickBase
	{
	public:
		/*** コンストラクタ */
		WarpExitGimmick();
