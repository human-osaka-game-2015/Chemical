/**
 * @file	BeltConveyorGimmick.h
 * @brief	ベルトコンベア右端ギミッククラス定義
 * @author	morimoto
 */
#ifndef GAME_BELTCONVEYORGIMMICK_H
#define GAME_BELTCONVEYORGIMMICK_H
...
{
	/*** ベルトコンベア右端ギミッククラス */
	class BeltConveyorGimmick : public StageGimmickBase
	{
	public:
		/*** コンストラクタ */
		BeltConveyorGimmick();
...
#endif // !GAME_BELTCONVEYORGIMMICK_H
