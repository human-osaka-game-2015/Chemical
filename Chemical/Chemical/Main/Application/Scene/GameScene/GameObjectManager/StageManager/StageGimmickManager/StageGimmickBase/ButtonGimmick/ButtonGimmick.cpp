...
namespace Game
{
	...
	//----------------------------------------------------------------------
	ButtonGimmick::ButtonGimmick() :
		StageGimmickBase("Resource\\GameScene\\Texture\\Gimmick5.png", "ButtonGimmick"),
		m_pCollision(new ButtonGimmickCollision(BUTTON_GIMMICK_COLLISION_ID)),
		m_pEvent(new ButtonGimmickEvent(BUTTON_GIMMICK_EVENT))
	{
	}
	...
	bool ButtonGimmick::CreateInstanceBuffer()
	{
		// ギミックの数が0なら生成しない.
	...
	void ButtonGimmick::ReleaseInstanceBuffer()
	{
