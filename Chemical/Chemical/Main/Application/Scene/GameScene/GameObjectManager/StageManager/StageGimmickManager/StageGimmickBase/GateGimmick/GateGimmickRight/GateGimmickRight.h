/**
 * @file	GateGimmickRight.h
 * @brief	門ギミック右側クラス定義
 * @author	morimoto
 */
#ifndef GAME_GATEGIMMICKRIGHT_H
#define GAME_GATEGIMMICKRIGHT_H
...
{
	/*** 門ギミック右側クラス */
	class GateGimmickRight : public StageGimmickBase
	{
	public:
		/*** コンストラクタ */
		GateGimmickRight();
