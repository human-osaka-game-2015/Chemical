...
namespace Game
{
	...
	//----------------------------------------------------------------------
	const D3DXVECTOR2 GateGimmickLeft::m_GateGimmickSize = D3DXVECTOR2(240, 320);


	//----------------------------------------------------------------------
	// Constructor	Destructor
	//----------------------------------------------------------------------
	GateGimmickLeft::GateGimmickLeft() :
		StageGimmickBase("Resource\\GameScene\\Texture\\Gimmick6_1.png", "GateGimmick"),
	...
	// Public Functions
	//----------------------------------------------------------------------
	bool GateGimmickLeft::Initialize()
	{
		m_pUpdateTask->SetName(m_TaskName);
		m_pDrawTask->SetName(m_TaskName);

		m_pDrawTask->SetPriority(GAME_DRAW_BACK_GIMMICK);
		...
		m_pReciveFunc = std::bind(&GateGimmickLeft::ReciveEvent, this, std::placeholders::_1);
	...
	void GateGimmickLeft::AddGimmick(int _x, int _y, int _data)
	{
	...
	void GateGimmickLeft::ClearChip()
	{
	...
	bool GateGimmickLeft::CreateInstanceBuffer()
	{
		// ギミックの数が0なら生成しない.
	...
	void GateGimmickLeft::ReleaseInstanceBuffer()
	{
	...
	// Private Functions
	//----------------------------------------------------------------------
	void GateGimmickLeft::ReciveEvent(Lib::EventBase* _pEvent)
	{
