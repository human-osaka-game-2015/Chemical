/**
 * @file	BeltConveyorGimmickLeft.cpp
...
// Include
//----------------------------------------------------------------------
#include "BeltConveyorGimmickLeft.h"
...
namespace Game
{
	...
	//----------------------------------------------------------------------
	BeltConveyorGimmickLeft::BeltConveyorGimmickLeft() :
		StageGimmickBase("Resource\\GameScene\\Texture\\Gimmick9.png", "BeltConveyorGimmickLeft"),
	...
	// Public Functions
	//----------------------------------------------------------------------
	bool BeltConveyorGimmickLeft::Initialize()
	{
	...
	void BeltConveyorGimmickLeft::Finalize()
	{
	...
	void BeltConveyorGimmickLeft::Update()
	{
	...
	void BeltConveyorGimmickLeft::Draw()
	{
	...
	void BeltConveyorGimmickLeft::AddGimmick(int _x, int _y, int _data)
	{
	...
	void BeltConveyorGimmickLeft::ClearChip()
	{
	...
	bool BeltConveyorGimmickLeft::CreateInstanceBuffer()
	{
		// ギミックの数が0なら生成しない.
	...
	void BeltConveyorGimmickLeft::ReleaseInstanceBuffer()
	{
