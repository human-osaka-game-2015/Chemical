/**
 * @file	BeltConveyorGimmickRight.h
 * @brief	ベルトコンベア右端ギミッククラス定義
 * @author	morimoto
 */
#ifndef GAME_BELTCONVEYORRIGHTGIMMICK_H
#define GAME_BELTCONVEYORRIGHTGIMMICK_H
...
{
	/*** ベルトコンベア右端ギミッククラス */
	class BeltConveyorGimmickRight : public StageGimmickBase
	{
	public:
		/*** コンストラクタ */
		BeltConveyorGimmickRight();

		/*** デストラクタ */
		virtual ~BeltConveyorGimmickRight();
...
#endif // !GAME_BELTCONVEYORRIGHTGIMMICK_H
