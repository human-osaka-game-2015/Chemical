...
namespace Game
{
	...
	//----------------------------------------------------------------------
	BeltConveyorGimmick::BeltConveyorGimmick() :
		StageGimmickBase("Resource\\GameScene\\Texture\\Gimmick8.png", "BeltConveyorGimmick"),
	...
	// Public Functions
	//----------------------------------------------------------------------
	bool BeltConveyorGimmick::Initialize()
	{
	...
	void BeltConveyorGimmick::Finalize()
	{
	...
	void BeltConveyorGimmick::Update()
	{
	...
	void BeltConveyorGimmick::AddGimmick(int _x, int _y, int _data)
	{
	...
	void BeltConveyorGimmick::ClearChip()
	{
	...
	bool BeltConveyorGimmick::CreateInstanceBuffer()
	{
		// ギミックの数が0なら生成しない.
	...
	void BeltConveyorGimmick::ReleaseInstanceBuffer()
	{
